...
import BlogGuestbookForm from 'app/blog/blog-guestbook'
import BlogGuestbookEntries from 'app/blog/blog-guestbook-entry'
  ...
  return (
    <>
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            image: post.metadata.image
              ? `https://buycoffee.top${post.metadata.image}`
              : `https://buycoffee.top/og?title=${post.metadata.title}`,
            url: `https://buycoffee.top/blog/${post.slug}`,
            author: {
              '@type': 'Person',
              name: 'Hamster1963',
            },
      ...
      <section className="mt-10">
        <BlogGuestbookForm slug={slug} />
        <BlogGuestbookEntries slug={slug} />
      </section>
